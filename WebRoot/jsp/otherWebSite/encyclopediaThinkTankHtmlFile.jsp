...
<BODY>
	<FORM id="pdfFileMerge" name="pdfFileMerge"
						...
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR class=manageHead>
								<TD>当前位置：<A class=style2
									...
									href="/Day29/encylopediaThinkTankWebSiteList" target=main>MBA智库百科</a>
								</TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR align="center"
													...
													<!-- <TD width="3"><input type="checkbox" id="checkAll"
														name="checkAll" onclick="checkAll1(this)"></TD> -->
													<TD width="35">序号</TD>
													<TD>本地地址</TD>
													<TD>网络地址</TD>
												...
												<c:forEach items="${webContentList }" var="webContent"
													varStatus="status">
													<TR align="center"
														style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
														<%-- <TD><input type="checkbox" id="item" name="item"
															value="${webContent.webContentId}" /></TD> --%>
														<%-- <TD width="2"><input type="checkbox" id="item" name="item"
															value="${webContent.webContentId}" /> --%>
														<TD width="35">${status.index+1}</TD>
														<TD><A class=style2
															href="${pageContext.request.contextPath}${webContent.storagePath}${webContent.webContentHtml}"
															target=_blank>${webContent.webSiteName}</A>
														<TD><A class=style2 href="${webContent.webSite}"
															target=_blank>${webContent.webSiteName}</A></TD>
