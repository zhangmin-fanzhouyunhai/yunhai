	...
	<TABLE cellSpacing=0 cellPadding=0 width="98%" border=0>
		<TBODY>
				...
				<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TR class=manageHead>
							<TD>当前位置： <A class=style2
								...
								target=main>其它功能</A> &gt; <a class=style2
									href="${pageContext.request.contextPath}/bibliographyAdd" target=main>参考文献添加</a>
							</TD>
					...
					<FORM id=form1 name=form1>
						<TABLE cellSpacing=0 cellPadding=5 border=0 align="center">
							<TR>
								<td>参考文献名称</td>
								<td><INPUT class=textbox id="bibliographyName"
									style="WIDTH: 180px" maxLength=500 name="bibliographyName"></td>
							</TR>
							<TR>
								<td>作者分组</td>
								<td><INPUT class=textbox id="authorGroupName"
									style="WIDTH: 180px" maxLength=100 name="authorGroupName"></td>
							</TR>
							<TR>
								<td>词意</td>
			...
			<TR>
				...
				<TD vAlign=top width="100%" bgColor=#ffffff align="center"><b>最新参考文献</b></TD>
				<TD width=15
					background="${pageContext.request.contextPath }/images/new_023.jpg">
					<IMG src="${pageContext.request.contextPath }/images/new_023.jpg"
					border=0>
			...
			<TR>
				...
				<TD vAlign=top width="100%" bgColor=#ffffff>
					<TABLE cellSpacing=0 cellPadding=5 width="98%" border=1>
						...
						<c:forEach items="${bibliographyList }" var="bibliography">
							<TR>
								<TD>${bibliography.bibliographyName}</TD>
								<TD>${bibliography.phoneticSymbol}</TD>
								<TD>${bibliography.wordMeaning}</TD>
								<TD align="center">${bibliography.createdDate}</TD>
							</TR>
						</c:forEach>
					</TABLE>
				</TD>
