...
<script type="text/javascript">
	...
	$(function() {
		...
		$("body").on("click", ".button", function() {
			...
			alert("files=" + files); 
			alert("<input type='text' name='versionValue' value='"+versionValue+"' />");
			alert("<input type='text' name='calYear' value='"+calYear+"' />");
			alert("<input type='file' name='pathStr' multiple='multiple' value='"+files+"' />");
			var form=$('<form>',{action:'/Day29/'+acValue , method:"post", enctype:"multipart/form-data"}).appendTo("body");
			form.append("<input type='text' name='versionValue' value='"+versionValue+"' />");
			form.append("<input type='text' name='calYear' value='"+calYear+"' />");
			form.append("<input type='file' name='pathStr' multiple='multiple' value='"+files+"' />");
			form.submit();
			/* 
			var imgFiles = [];
