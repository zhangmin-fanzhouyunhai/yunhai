						...
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：<A class=style2
									href="${pageContext.request.contextPath }/jsp/excelImport/uploadMultipleFile.jsp"
									target=main>文件上传</A> &gt; pdf合并
								</TD>
							</TR>
							<TR>
								<TD height=2></TD>
									...
									<TD height=25>
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>合并后文件名:</TD>
													<TD><INPUT class=textbox id="mergeFileName"
														style="WIDTH: 120px" maxLength=200 name="mergeFileName"></TD>

													<TD><INPUT class=button id=sButton2 type=submit
														value="合并" name=sButton2></TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<c:forEach items="${fileList }" var="file" varStatus="status">
													...
													<TD><input type="text" id="sortIndex" name="sortIndex" align="center" value="${status.index+1 }"size="1"/></TD>
