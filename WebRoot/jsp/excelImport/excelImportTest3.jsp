...
<script type="text/javascript">
	...
	$(function() {
		...
		$("body").on("click", ".button", function() {
			...
			//alert("url=" + url);
			//var enctypeVal = $(this).prop("tagName");
			//alert("enctype="+enctypeVal); 
			//enctypeVal = $(this).parent().parent().parent().prop("tagName");
			//alert("enctype="+enctypeVal); 
			...
			var alldata=formObj.serialize();
			alert("alldata="+alldata);
			var form_param=$.parseParams(alldata);
			alert(form_param);
			//formObj.submit();
