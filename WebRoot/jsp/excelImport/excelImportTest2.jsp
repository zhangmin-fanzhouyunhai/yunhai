...
<body>
	...
	<table class="table table-striped" width="50%"> 
			...
			<tr> 
			<form name="zfiSwzcDiscIncrAdd" method="post"
				action="${pageContext.request.contextPath }/zfiSwzcDiscIncrAdd"
			...
			<tr>
			<form name="oriOpticalCableSectionAdd" method="post"
			...
			<tr>
			<form name="spareEquipmentImportServlet" method="post" action="${pageContext.request.contextPath }/spareEquipmentImportServlet" enctype="multipart/form-data">
				<table>
				<tr align="center">
