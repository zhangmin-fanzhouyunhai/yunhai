...
<BODY>
	<FORM
		id="existFileListForm" name="existFileListForm" method=post>
												...
												<c:forEach items="${fileList }" var="file"
													...
													<TR align="center"
														...
														<TD><input type="checkbox" id="item" name="item"
															value="${file.fileName}" /></TD>
														<TD><input type="text" id="sortIndex"
															name="sortIndex" align="center"
															value="${status.index+1 }" size="1" /></TD>
														<TD> <A
															class=style2
															href="${pageContext.request.contextPath}/excelSheetListSave?owner=admin&fileName=${file.fileName}&userFolder=${file.path}">${file.fileName}</A>
														</TD>
