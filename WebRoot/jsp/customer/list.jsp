										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<%-- <TD><span id="custName" ondblclick="edit(this)">${customer.custName }</span></TD>
													<TD><span id="custLevel" ondblclick="edit(this)">${customer.custLevel }</span></TD>
													<TD><span id="custSource" ondblclick="edit(this)">${customer.custSource }</span></TD>
													<TD><span id="custLinkman" ondblclick="edit(this)">${customer.custLinkman }</span></TD>
													<TD><span id="custPhone" ondblclick="edit(this)">${customer.custPhone }</span></TD>
													<TD><span id="custMobile" ondblclick="edit(this)">${customer.custMobile }</span></TD> --%>
