...
<BODY>
	<FORM id="sheetList" name="sheetList"  method=post>
						...
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR class=manageHead>
								<TD>当前位置：<A class=style2
									...
									href="${pageContext.request.contextPath}/excelFileListServlet"
									target=main>excel文件清单</A> &gt; ExcelSheet清单
								</TD>
											...
											<TBODY>
												...
												<c:forEach items="${sheetList }" var="sheet"
													...
													<TR align="center"
														...
														<TD id = "excelSheetIndex" ondblclick="edit(this)"><input type="text" id="sortIndex"
															name="sortIndex" align="center"
															value="${sheet.sortIndex }" size="1" /></TD>
														<TD id = "excelSheetName" ondblclick="edit(this)"><input type="hidden" name="excelSheetName"
															id="excelSheetName" value="${sheet.excelSheetName}" /> <A
															class=style2
															href="${pageContext.request.contextPath}/columnListServlet?owner=admin&excelFileId=${sheet.excelFileId}&excelSheetId=${sheet.excelSheetId}">${sheet.excelSheetName}</A>
														</TD>
