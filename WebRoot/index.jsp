		...
		<div class="container-fluid">
			...
			<div class="col-md-3" style="padding-top:20px">
				<ol class="list-inline">
					...
					<li><a href="login.jsp">登录1</a></li>
					<li><a href="loginEasyUI.jsp">登录2</a></li>
					<li><a href="projectLearn/day10/register.html">注册</a></li>
					<li><a href="projectLearn/day11/cart.html">购物车</a></li>
					<li><A href="./html/webBasicLearn.html">－基础Web学习</A></li>
					<li><A class=style2 href="../jsp/wuBiInputMethodWordInput.jsp"
						target=main>五笔词组插入</A></li>
				</ol>
			</div>
		</div>
		<!--
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse"
						...
						<ul class="nav navbar-nav">
							...
							<li><a href="projectLearn/day11/index.jsp">电脑办公</a></li>
							<li><a href="#">电脑办公</a></li>
							<li><a href="#">电脑办公</a></li>
						</ul>
