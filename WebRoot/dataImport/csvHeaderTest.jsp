	...
	<FORM id="form1" name="form1"
		...
		<table class="table table-striped">
			...
			<tbody>
				<tr align="center">
					<td>
					ERP报废数据（zfiSwzcDiscIncrAdd）
					<input type="hidden" value="zfiSwzcDiscIncrAdd" class="ac">
					</td>
				...
				<tr align="center">
					<td >TMS样本数据导入
					<input type="hidden" value="oriOpticalCableSectionAdd" class="ac">
					</td>
					<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
						maxLength=50 name="versionValue"></td>
					<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
				...
				<tr align="center">
					<td >备品备件（spareEquipmentImportServlet）
					<input type="hidden" value="spareEquipmentImportServlet" class="ac">
					</td>
					<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
						maxLength=50 name="versionValue"></td>
					<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
