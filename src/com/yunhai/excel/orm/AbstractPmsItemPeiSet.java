...
/**
 * AbstractPmsItemPeiSet entity provides the base persistence definition of the
 * PmsItemPeiSet entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractPmsItemPeiSet implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4419101512047117683L;
	private String pmsItemPeiSetId;
	...
	/** default constructor */
	public AbstractPmsItemPeiSet() {
	}

	/** minimal constructor */
	public AbstractPmsItemPeiSet(Short calYear, String version) {
		this.calYear = calYear;
		this.version = version;
	}
	/** full constructor */
	public AbstractPmsItemPeiSet(Short calYear, String version, String sbbm, String dwmx, String ywdw, String zckbm,
	...
	public String getPmsItemPeiSetId() {
		return this.pmsItemPeiSetId;
	}
	...
	public void setPmsItemPeiSetId(String pmsItemPeiSetId) {
		this.pmsItemPeiSetId = pmsItemPeiSetId;
	}
