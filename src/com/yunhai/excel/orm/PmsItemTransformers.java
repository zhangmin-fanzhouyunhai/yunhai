...
/**
 * PmsItemTransformers entity. @author MyEclipse Persistence Tools
 */
public class PmsItemTransformers extends AbstractPmsItemTransformers implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4379084258060006917L;

	/** default constructor */
	public PmsItemTransformers() {
	}

	/** minimal constructor */
	public PmsItemTransformers(Short calYear, String version) {
		super(calYear, version);
	}

	/** full constructor */
	public PmsItemTransformers(Short calYear, String version, String sbbm, String dwmx, String ywdw, String zckbm,
