...
/**
 * OElectricReactorCollect entity. @author MyEclipse Persistence Tools
 */
public class OElectricReactorCollect extends AbstractOElectricReactorCollect implements java.io.Serializable {

	// Constructors

	/** default constructor */
	public OElectricReactorCollect() {
	}

	/** minimal constructor */
	public OElectricReactorCollect(String OElectricReactorCollectId, String dataVersion, Date calYear) {
		super(OElectricReactorCollectId, dataVersion, calYear);
	}
	...
	public OElectricReactorCollect(String OElectricReactorCollectId, String dataVersion, Date calYear,
		...
		super(OElectricReactorCollectId, dataVersion, calYear, projectType, equipmentId, equipmentName, voltageLevel,
				operationDate, insulatingMedium, installationMode, accessMode, coolingMode, voltageRegulationMode,
				whetherRuralPowerNetwork, ratedVoltage, ratedCurrent, ratedFrequency, ratedCapacity, ratedReactance,
				ratedReactanceRate, ratedInductance, assetId, physicalId, pmId, belongLocalCityCompany,
				belongSubstation, useEnvironment, workingAge, lifeCycle, averageAnnualInterestRate, lifeCycleCost,
				lccIniInvesCostEquipValue, lccIniInvesCostInstalCost, lccIniInvementCostOthers,
				lccTotalIniInvestmentCost, lccOperMaintAnnOpPatro17, lccOperMaintAnnOpPatro18, lccOperMaintAnnOpPatro19,
				lccOperMaintAnnOpPatro20, lccOperMaintAnnOpPatro21, lccOperMaintAnnOpEchec17, lccOperMaintAnnOpEchec18,
				lccOperMaintAnnOpEchec19, lccOperMaintAnnOpEchec20, lccOperMaintAnnOpEchec21, lccOperMaintAnnOpeTota17,
				lccOperMaintAnnOpeTota18, lccOperMaintAnnOpeTota19, lccOperMaintAnnOpeTota20, lccOperMaintAnnOpeTota21,
				lccOperMaintAnnRepOver17, lccOperMaintAnnRepOver18, lccOperMaintAnnRepOver19, lccOperMaintAnnRepOver20,
				lccOperMaintAnnRepOver21, lccOperMaintAnnRepDefe17, lccOperMaintAnnRepDefe18, lccOperMaintAnnRepDefe19,
				lccOperMaintAnnRepDefe20, lccOperMaintAnnRepDefe21, lccOperMaintAnnRepTota17, lccOperMaintAnnRepTota18,
				lccOperMaintAnnRepTota19, lccOperMaintAnnRepTota20, lccOperMaintAnnRepTota21, lccOperMaintAnnFaiCost17,
				lccOperMaintAnnFaiCost18, lccOperMaintAnnFaiCost19, lccOperMaintAnnFaiCost20, lccOperMaintAnnFaiCost21,
				lccOperMaintTotalCost2017, lccOperMaintTotalCost2018, lccOperMaintTotalCost2019,
				lccOperMaintTotalCost2020, lccOperMaintTotalCost2021, lccOperMaintCostLatest5y,
				lccTechTransformaInves2017, lccTechTransformaInves2018, lccTechTransformaInves2019,
				lccTechTransformaInves2020, lccTechTransformaInves2021, lccAbandonCostDisposIncome,
				lccAbandonCostDisposCost);
	}
	...
	public OElectricReactorCollect(String oElectricReactorCollectId, String dataVersion, Date calYear,
			...
			Double lccTechTransformaInves2018, Double lccTechTransformaInves2019, Double lccTechTransformaInves2020,
			Double lccTechTransformaInves2021, Double lccAbandonCostDisposIncome, Double lccAbandonCostDisposCost) {
		super(oElectricReactorCollectId, dataVersion, calYear, dataSourceFile, projectType, equipmentId, equipmentName,
				voltageLevel, operationDate, insulatingMedium, installationMode, accessMode, coolingMode, voltageRegulationMode,
				whetherRuralPowerNetwork, ratedVoltage, ratedCurrent, ratedFrequency, ratedCapacity, ratedReactance,
				ratedReactanceRate, ratedInductance, assetId, physicalId, pmId, belongLocalCityCompany, belongSubstation,
