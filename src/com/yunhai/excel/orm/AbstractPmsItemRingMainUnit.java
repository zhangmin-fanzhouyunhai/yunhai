...
/**
 * AbstractPmsItemRingMainUnit entity provides the base persistence definition
 * of the PmsItemRingMainUnit entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractPmsItemRingMainUnit implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3481455516149352466L;
	private String pmsItemRingMainUnitId;
	...
	/** default constructor */
	public AbstractPmsItemRingMainUnit() {
	}

	/** minimal constructor */
	public AbstractPmsItemRingMainUnit(Short calYear, String version) {
		this.calYear = calYear;
		this.version = version;
	}

	/** full constructor */
	public AbstractPmsItemRingMainUnit(Short calYear, String version, String sbbm, String dwmx, String ywdw,
			String zckbm, String sblx, Double zcyz, String zcdl, String zclxbm, String cwbm, String dydj, String yxzt,
			String jkzt, Date zjtyrq, String zcxz, Double sl, Double sl1, Double sl2, Double sl3, String jldw,
			String zzsmc, String ssxlbdz, String sbxh, Short tynf, String nnd, Date tyrq, Short nn, String qfzd,
			Date ccrq, String equipmentName, String assetId, String equipmentIncreaseMode, String lineProperty,String dataSourceFile) {
		this.calYear = calYear;
		this.version = version;
		this.sbbm = sbbm;
		this.dwmx = dwmx;
	...
	public AbstractPmsItemRingMainUnit(Short calYear, String version, String sbbm, String dwmx, String ywdw,
			...
			String jkzt, Date zjtyrq, String zcxz, Double sl, Double sl1, Double sl2, Double sl3, String jldw,
			String zzsmc, String ssxlbdz, String sbxh, Short tynf, String nnd, Date tyrq, Short nn, String qfzd,
			Date ccrq, String equipmentName, String assetId, String equipmentIncreaseMode, String dataSourceFile) {
		this.calYear = calYear;
		this.version = version;
		this.sbbm = sbbm;
		this.dwmx = dwmx;
	...
	public String getPmsItemRingMainUnitId() {
		return this.pmsItemRingMainUnitId;
	}
	...
	public void setPmsItemRingMainUnitId(String pmsItemRingMainUnitId) {
		this.pmsItemRingMainUnitId = pmsItemRingMainUnitId;
	}
