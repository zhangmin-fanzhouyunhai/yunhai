...
/**
 * AbstractZfiSwzcNo16classValue entity provides the base persistence definition
 * of the ZfiSwzcNo16classValue entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractZfiSwzcNo16classValue implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractZfiSwzcNo16classValue() {
	}

	/** minimal constructor */
	public AbstractZfiSwzcNo16classValue(String zfiSwzc16classValueId) {
		this.zfiSwzc16classValueId = zfiSwzc16classValueId;
	}

	/** full constructor */
	public AbstractZfiSwzcNo16classValue(String zfiSwzc16classValueId, String dataVersion, Date calYear,
