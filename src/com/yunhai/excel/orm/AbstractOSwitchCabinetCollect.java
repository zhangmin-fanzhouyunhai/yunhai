...
/**
 * AbstractOSwitchCabinetCollect entity provides the base persistence definition
 * of the OSwitchCabinetCollect entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractOSwitchCabinetCollect implements java.io.Serializable {

	// Fields

	private String OSwitchCabinetCollectId;
	...
	/** default constructor */
	public AbstractOSwitchCabinetCollect() {
	}

	/** minimal constructor */
	public AbstractOSwitchCabinetCollect(String OSwitchCabinetCollectId, String dataVersion, Date calYear) {
		this.OSwitchCabinetCollectId = OSwitchCabinetCollectId;
	...
	public AbstractOSwitchCabinetCollect(String oSwitchCabinetCollectId, String dataVersion, Date calYear,
			...
			Double lccAbandonCostDisposCost) {
		super();
		OSwitchCabinetCollectId = oSwitchCabinetCollectId;
		this.dataVersion = dataVersion;
		this.calYear = calYear;
	...
	public String getOSwitchCabinetCollectId() {
		return this.OSwitchCabinetCollectId;
	}

	public void setOSwitchCabinetCollectId(String OSwitchCabinetCollectId) {
		this.OSwitchCabinetCollectId = OSwitchCabinetCollectId;
	}
