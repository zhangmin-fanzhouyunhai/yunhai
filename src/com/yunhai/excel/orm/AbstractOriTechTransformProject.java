...
/**
 * AbstractOriTechTransformProject entity provides the base persistence definition of the OriTechTransformProject entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractOriTechTransformProject  implements java.io.Serializable {


    // Fields    

     private String oriTechTransformProjectId;
    ...
    public String getOriTechTransformProjectId() {
        return this.oriTechTransformProjectId;
    }
    
    public void setOriTechTransformProjectId(String oriTechTransformProjectId) {
        this.oriTechTransformProjectId = oriTechTransformProjectId;
    }
