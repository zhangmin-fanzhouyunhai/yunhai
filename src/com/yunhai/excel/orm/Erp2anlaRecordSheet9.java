...
/**
 * Erp2anlaRecordSheet9 entity. @author MyEclipse Persistence Tools
 */
public class Erp2anlaRecordSheet9 extends AbstractErp2anlaRecordSheet9 implements java.io.Serializable {

	// Constructors

	/** default constructor */
	public Erp2anlaRecordSheet9() {
	}

	/** minimal constructor */
	public Erp2anlaRecordSheet9(Date calYear) {
		super(calYear);
	}

	/** full constructor */
	public Erp2anlaRecordSheet9(Date calYear, String companyCode, String assetId, String equipmentId,
