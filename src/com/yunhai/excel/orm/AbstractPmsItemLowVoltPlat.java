...
/**
 * AbstractPmsItemLowVoltPlat entity provides the base persistence definition of
 * the PmsItemLowVoltPlat entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractPmsItemLowVoltPlat implements java.io.Serializable {

	// Fields

	private String pmsItemLowVoltPlatId;
	...
	/** default constructor */
	public AbstractPmsItemLowVoltPlat() {
	}

	/** minimal constructor */
	public AbstractPmsItemLowVoltPlat(String pmsItemLowVoltPlatId, Short calYear, String version) {
		this.pmsItemLowVoltPlatId = pmsItemLowVoltPlatId;
		this.calYear = calYear;
		this.version = version;
	}

	/** full constructor */
	public AbstractPmsItemLowVoltPlat(String pmsItemLowVoltPlatId, Short calYear, String version, String sbbm,
			String dwmx, String ywdw, String zckbm, String sblx, Double zcyz, String zcdl, String zclxbm, String cwbm,
			String dydj, String yxzt, String jkzt, Date zjtyrq, String zcxz, Double sl, Double sl1, Double sl2,
			Double sl3, String jldw, String zzsmc, String ssxlbdz, String sbxh, Short tynf, String nnd, Date tyrq,
			Short nn, String qfzd, Date ccrq, String equipmentName, String assetId, String equipmentIncreaseMode,
	...
	public String getPmsItemLowVoltPlatId() {
		return this.pmsItemLowVoltPlatId;
	}

	public void setPmsItemLowVoltPlatId(String pmsItemLowVoltPlatId) {
		this.pmsItemLowVoltPlatId = pmsItemLowVoltPlatId;
	}
