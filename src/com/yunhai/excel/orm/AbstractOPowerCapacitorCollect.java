...
/**
 * AbstractOPowerCapacitorCollect entity provides the base persistence
 * definition of the OPowerCapacitorCollect entity. @author MyEclipse
 * Persistence Tools
 */

public abstract class AbstractOPowerCapacitorCollect implements java.io.Serializable {

	// Fields

	private String OPowerCapacitorCollectId;
	...
	/** default constructor */
	public AbstractOPowerCapacitorCollect() {
	}

	/** minimal constructor */
	public AbstractOPowerCapacitorCollect(String OPowerCapacitorCollectId, String dataVersion, Date calYear) {
		this.OPowerCapacitorCollectId = OPowerCapacitorCollectId;
	...
	public AbstractOPowerCapacitorCollect(String oPowerCapacitorCollectId, String dataVersion, Date calYear,
			...
			Date operationDate, String insulatingMedium, String installationMode, String accessMode, String wiringMode,
			String whetherRuralPowerNetwork, String ratedVoltage, Double ratedCurrent, Double ratedFrequency,
			Double singleCapacity, Double capacitanceValue, String assetId, String physicalId, String pmId,
		...
		super();
		OPowerCapacitorCollectId = oPowerCapacitorCollectId;
		this.dataVersion = dataVersion;
		this.calYear = calYear;
	...
	public String getOPowerCapacitorCollectId() {
		return this.OPowerCapacitorCollectId;
	}

	public void setOPowerCapacitorCollectId(String OPowerCapacitorCollectId) {
		this.OPowerCapacitorCollectId = OPowerCapacitorCollectId;
	}
