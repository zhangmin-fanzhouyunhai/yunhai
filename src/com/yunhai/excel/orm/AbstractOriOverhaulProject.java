...
/**
 * AbstractOriOverhaulProject entity provides the base persistence definition of
 * the OriOverhaulProject entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractOriOverhaulProject implements java.io.Serializable {

	// Fields

	private String oriOverhaulProjectId;
	...
	/** default constructor */
	public AbstractOriOverhaulProject() {
	}

	/** minimal constructor */
	public AbstractOriOverhaulProject(String oriOverhaulProjectId) {
		this.oriOverhaulProjectId = oriOverhaulProjectId;
	}

	/** full constructor */
	public AbstractOriOverhaulProject(String oriOverhaulProjectId, Integer recordNum, String objId, String projectId,
	...
	public String getOriOverhaulProjectId() {
		return this.oriOverhaulProjectId;
	}

	public void setOriOverhaulProjectId(String oriOverhaulProjectId) {
		this.oriOverhaulProjectId = oriOverhaulProjectId;
	}
