...
/**
 * PmsItemTransSet entity. @author MyEclipse Persistence Tools
 */
public class PmsItemTransSet extends AbstractPmsItemTransSet implements java.io.Serializable {

	// Constructors

	/** default constructor */
	public PmsItemTransSet() {
	}

	/** minimal constructor */
	public PmsItemTransSet(Short calYear, String version) {
		super(calYear, version);
	}

	/** full constructor */
	public PmsItemTransSet(Short calYear, String version, String sbbm, String dwmx, String ywdw, String zckbm,
