...
/**
 * AbstractErpItemDiscardHebei entity provides the base persistence definition
 * of the ErpItemDiscardHebei entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractErpItemDiscardHebei implements java.io.Serializable {

	// Fields

	private String erpItemDiscardHebeiId;
	...
	private String discardProjectType;
	private String discardReasonStandardValue;

	// Constructors

	/** default constructor */
	public AbstractErpItemDiscardHebei() {
	}

	/** full constructor */
	public AbstractErpItemDiscardHebei(String version, Date calYear, String mandt, Integer calyear, String compCode,
			String assetMain, String asset, String equnr, String currency, BigDecimal zpmzcyz, BigDecimal zpmzcjz,
			String ztypbz1, String ztypbz1t, String ztypbz2, String ztypbz2t, String ztypbz3, String ztypbz3t,
			String zvolLev, BigDecimal zquantity, String unit, String zioZczt, String profitCtr, String zlrzx,
			String coArea, String zzcms, String zioZxmlx, String aktiv, String deakt, String anlkl, String txk20,
			String sernr, String invnr, String zzc001, String zzc002, String kostl, String ltext, String kostlv,
			String raumn, String kfzkz, String zzas1, String zzc006, String zzc007, String ord41, String ord44,
			String gdlgrp, String izwek, String umwkz, String anlue, String herst, String typbz, String stext4,
			...
			String cname, String discardProjectType, String discardReasonStandardValue) {
		...
		this.ctime = ctime;
		this.cname = cname;
		this.discardProjectType = discardProjectType;
		this.discardReasonStandardValue = discardReasonStandardValue;
	}

	// Property accessors

	public String getErpItemDiscardHebeiId() {
		return this.erpItemDiscardHebeiId;
	}

	public void setErpItemDiscardHebeiId(String erpItemDiscardHebeiId) {
		this.erpItemDiscardHebeiId = erpItemDiscardHebeiId;
	}
	...
	public String getDiscardProjectType() {
		return this.discardProjectType;
	}

	public void setDiscardProjectType(String discardProjectType) {
		this.discardProjectType = discardProjectType;
	}

	public String getDiscardReasonStandardValue() {
		return this.discardReasonStandardValue;
	}

	public void setDiscardReasonStandardValue(String discardReasonStandardValue) {
		this.discardReasonStandardValue = discardReasonStandardValue;
	}
