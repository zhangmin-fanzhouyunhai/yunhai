...
/**
 * AbstractMidDiscardReasDistEqu20 entity provides the base persistence
 * definition of the MidDiscardReasDistEqu20 entity. @author MyEclipse
 * Persistence Tools
 */

public abstract class AbstractMidDiscardReasDistEqu20 implements java.io.Serializable {

	// Fields

	private String midDiscarReasDistEqu20Id;
	...
	private Double totalDiscardAssetOrigValue;
	private Double totalDiscardAssetNetValue;
	private Double totalDiscardAssetQuantity;
	...
	/** default constructor */
	public AbstractMidDiscardReasDistEqu20() {
	}

	/** minimal constructor */
	public AbstractMidDiscardReasDistEqu20(String midDiscarReasDistEqu20Id) {
		this.midDiscarReasDistEqu20Id = midDiscarReasDistEqu20Id;
	}

	/** full constructor */
	public AbstractMidDiscardReasDistEqu20(String midDiscarReasDistEqu20Id, String version, Date calYear,
			...
			Double totalDiscardAssetOrigValue, Double totalDiscardAssetNetValue, Double totalDiscardAssetQuantity,
		...
		this.totalDiscardAssetOrigValue = totalDiscardAssetOrigValue;
		this.totalDiscardAssetNetValue = totalDiscardAssetNetValue;
		this.totalDiscardAssetQuantity = totalDiscardAssetQuantity;
	...
	public String getMidDiscarReasDistEqu20Id() {
		return this.midDiscarReasDistEqu20Id;
	}

	public void setMidDiscarReasDistEqu20Id(String midDiscarReasDistEqu20Id) {
		this.midDiscarReasDistEqu20Id = midDiscarReasDistEqu20Id;
	}
	...
	public Double getTotalDiscardAssetOrigValue() {
		return this.totalDiscardAssetOrigValue;
	}

	public void setTotalDiscardAssetOrigValue(Double totalDiscardAssetOrigValue) {
		this.totalDiscardAssetOrigValue = totalDiscardAssetOrigValue;
	}

	public Double getTotalDiscardAssetNetValue() {
		return this.totalDiscardAssetNetValue;
	}

	public void setTotalDiscardAssetNetValue(Double totalDiscardAssetNetValue) {
		this.totalDiscardAssetNetValue = totalDiscardAssetNetValue;
	}

	public Double getTotalDiscardAssetQuantity() {
		return this.totalDiscardAssetQuantity;
	}

	public void setTotalDiscardAssetQuantity(Double totalDiscardAssetQuantity) {
		this.totalDiscardAssetQuantity = totalDiscardAssetQuantity;
	}
