...
/**
 * AbstractMidDiscardReasDistEqu5 entity provides the base persistence
 * definition of the MidDiscardReasDistEqu5 entity. @author MyEclipse
 * Persistence Tools
 */

public abstract class AbstractMidDiscardReasDistEqu5 implements java.io.Serializable {

	// Fields

	private String midDiscarReasDistEqu5Id;
	...
	private Double totalDiscardOrigValue;
	private Double totalDiscardNetValue;
	private Double totalDiscardQuantity;
	...
	/** default constructor */
	public AbstractMidDiscardReasDistEqu5() {
	}

	/** minimal constructor */
	public AbstractMidDiscardReasDistEqu5(String midDiscarReasDistEqu5Id) {
		this.midDiscarReasDistEqu5Id = midDiscarReasDistEqu5Id;
	}

	/** full constructor */
	public AbstractMidDiscardReasDistEqu5(String midDiscarReasDistEqu5Id, String version, Date calYear,
			...
			Double totalDiscardOrigValue, Double totalDiscardNetValue, Double totalDiscardQuantity,
		...
		this.totalDiscardOrigValue = totalDiscardOrigValue;
		this.totalDiscardNetValue = totalDiscardNetValue;
		this.totalDiscardQuantity = totalDiscardQuantity;
	...
	public String getMidDiscarReasDistEqu5Id() {
		return this.midDiscarReasDistEqu5Id;
	}

	public void setMidDiscarReasDistEqu5Id(String midDiscarReasDistEqu5Id) {
		this.midDiscarReasDistEqu5Id = midDiscarReasDistEqu5Id;
	}
	...
	public Double getTotalDiscardOrigValue() {
		return this.totalDiscardOrigValue;
	}

	public void setTotalDiscardOrigValue(Double totalDiscardOrigValue) {
		this.totalDiscardOrigValue = totalDiscardOrigValue;
	}

	public Double getTotalDiscardNetValue() {
		return this.totalDiscardNetValue;
	}

	public void setTotalDiscardNetValue(Double totalDiscardNetValue) {
		this.totalDiscardNetValue = totalDiscardNetValue;
	}

	public Double getTotalDiscardQuantity() {
		return this.totalDiscardQuantity;
	}

	public void setTotalDiscardQuantity(Double totalDiscardQuantity) {
		this.totalDiscardQuantity = totalDiscardQuantity;
	}
