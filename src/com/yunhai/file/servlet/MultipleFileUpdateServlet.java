...
@WebServlet("/multipleFileUpdateServlet")
@MultipartConfig
public class MultipleFileUpdateServlet extends HttpServlet {
	...
	public MultipleFileUpdateServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String userFolder="/userFile/excel";
		...
		for (Part p : parts) {
			...
			if (p.getSubmittedFileName() != null) {
				...
				fileList.add(new UploadFile(fileName,savePath + File.separator + fileName,userFolder,null));
		...
		request.setAttribute("fileList", fileList);
		 ...
		 request.getRequestDispatcher("/jsp/excelImport/uploadFileList.jsp").
