 ...
 */ 
@WebServlet("/spareEquipmentImportServlet2")
public class SpareEquipmentImportServlet2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("versionValue=" + versionValue + ",calYear=" + calYear);
		String pathStr=request.getParameter("pathStr");
		// 存储路径
		String savePath = request.getServletContext().getRealPath("/userFile/excel");
		//
		System.out.println("spareEquipmentImportServlet2,savePath=" + savePath +",pathStr=" + pathStr +",versionValue=" + versionValue + ",calYear=" + calYear);
		// 获取上传的文件集合
