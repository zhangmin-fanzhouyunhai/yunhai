...
@WebServlet("/oriOpticalCableSectionAdd")
@MultipartConfig
public class OriOpticalCableSectionServlet extends HttpServlet {
	private static final long serialVersionUID = 2045095885972804611L;

	public OriOpticalCableSectionServlet() {
		super();
	} 
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String savePath = request.getServletContext().
		 ...
		 System.out.println("savePath=" + savePath +",versionValue=" + versionValue +
		 ",calYear=" + calYear);
		// 获取上传的文件集合
		...
		// 上传单个文件 
		new CsvImportService().oriOpticalCableSectionSave(
				savePath + "\\" + fileName2, versionValue, calYear);
		// 转发/jsp/excelImport/add.jsp
		request.getRequestDispatcher("/jsp/excelImport/excelImport.jsp").
