package com.itheima.day13.domain.reflect;
...
public class Demo {
	...
	@Test
	public void f1() throws NoSuchMethodException, SecurityException, ClassNotFoundException, InstantiationException,
	...
	@Test
	public void midErpItemTest() throws ClassNotFoundException, SQLException {
	...
	@Test
	public void f2() throws NoSuchMethodException, SecurityException, ClassNotFoundException, InstantiationException,
			IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		// 1.获取class对象
		Class clazz = Class.forName("com.itheima.day13.orm.Person");
		// 2.获取构造器
	...
	@Test
	// 获取私有方法
	public void f3() throws NoSuchMethodException, SecurityException, ClassNotFoundException, InstantiationException,
			IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		// 1.获取class对象
		Class clazz = Class.forName("com.itheima.day13.orm.Person");
		Person person = (Person) clazz.newInstance();
		// 2.获取方法
		// Method method=clazz.getMethod("sleep" );//获取公共的方法
		Method method = clazz.getDeclaredMethod("sleep");// 获取所有的方法
	...
	@Test
	// 获取私有方法
	public void f11() throws NoSuchMethodException, SecurityException, ClassNotFoundException, InstantiationException,
			IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		// 1.获取class对象
		Class clazz = Class.forName("com.itheima.day13.orm.Person");
		Person person = (Person) clazz.newInstance();
		// 2.获取私有的方法
		Method method = clazz.getDeclaredMethod("sleep", String.class);// 获取所有的方法
		// System.out.println(method);
		// 2.1若是私有的方法，必须让该方法可以访问
		method.setAccessible(true);

		// 执行方法
		String result = (String) method.invoke(person, "老候");
		// method.invoke(clazz.newInstance());
